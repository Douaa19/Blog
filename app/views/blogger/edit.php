...
<div class="container">
    ...
    <form action="<?php echo URLROOT; ?>/PosteController/edit" method="POST" class="mt-3 row">
        <div class="card p-5">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <textarea name="contenu" class="form-control" id="texte" value="<?php echo $data->contenu_poste; ?>"></textarea>
            </div>
        </div>
        <p class="col-5"></p>
